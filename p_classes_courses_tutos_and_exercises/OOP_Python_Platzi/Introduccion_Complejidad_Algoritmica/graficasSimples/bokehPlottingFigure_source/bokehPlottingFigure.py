...
[docs]    @glyph_method(glyphs.AnnularWedge)
    def annular_wedge(self, **kwargs):
        pass


[docs]    @glyph_method(glyphs.Annulus)
...
[docs]    @glyph_method(glyphs.Bezier)
    def bezier(self, **kwargs):
        pass


[docs]    @glyph_method(glyphs.Circle)
...
[docs]    @glyph_method(glyphs.HArea)
...
[docs]    @glyph_method(glyphs.Ellipse)
...
[docs]    @glyph_method(glyphs.HexTile)
...
[docs]    @glyph_method(glyphs.Image)
...
[docs]    @glyph_method(glyphs.ImageRGBA)
...
[docs]    @glyph_method(glyphs.ImageURL)
...
[docs]    @glyph_method(glyphs.MultiLine)
...
[docs]    @glyph_method(glyphs.MultiPolygons)
...
[docs]    @glyph_method(glyphs.Patch)
...
[docs]    @glyph_method(glyphs.Patches)
...
[docs]    @glyph_method(glyphs.Quadratic)
    def quadratic(self, **kwargs):
        pass


[docs]    @glyph_method(glyphs.Ray)
    def ray(self, **kwargs):
        """
Examples:
...
[docs]    @glyph_method(glyphs.Segment)
...
[docs]    @glyph_method(glyphs.VArea)
...
[docs]    @glyph_method(glyphs.Wedge)
...
[docs]    def hexbin(self, x, y, size, orientation="pointytop", palette="Viridis256", line_color=None, fill_color=None, aspect_scale=1, **kwargs):
...
[docs]    def harea_stack(self, stackers, **kw):
...
[docs]    def hbar_stack(self, stackers, **kw):
...
[docs]    def hline_stack(self, stackers, **kw):
...
[docs]    def varea_stack(self, stackers, **kw):
...
[docs]    def vbar_stack(self, stackers, **kw):
...
[docs]    def vline_stack(self, stackers, **kw):
        ''' Generate multiple ``Line`` renderers for lines stacked vertically.
...
[docs]    def graph(self, node_source, edge_source, layout_provider, **kwargs):
